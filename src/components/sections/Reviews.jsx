...
import StefanHE from "../../assets/avatars/Stefan_HE.jpg";
import JacquelineKressner from "../../assets/avatars/Jacqueline_Kressner.png";
import MartinaSokoleska from "../../assets/avatars/Martina_Sokoleska.jpg";
...
const reviews = [
  ...
  },
  {
    ...
    avatar: MartinaSokoleska,
    earnings: "€559 this month",
    rating: 5,
    quote:
      "The world is changing very quickly. After COVID-19, the digitalization process accelerated at full speed, and cash has begun turning into digital money. That’s why, when I first heard about the idea behind this project, it felt promising and truly inspiring. We are making a meaningful contribution to this digital transformation, and I’m glad to be part of it.",
    provider: "stripe",
  },
  {
    id: 3,
    ...
    rating: 5,
    quote:
      "In many workplaces, tips are collected but not always distributed fairly, and customers often have no insight into where their tip actually ends up. A digital tipping app creates a clear and trustworthy path between the person who gives and the person who earns. It ensures that every contribution reaches the right hands, without confusion or middle-steps. By introducing transparency into an area that has long relied on guesswork, this kind of app empowers workers, reassures customers, and sets a new standard for fairness in the service industry.",
    provider: "stripe",
  },
];
