...
import SP1Image from "../../assets/images/HIW-SP1-Generate_QRcode.jpg";
import SP2Image from "../../assets/images/HIW-SP2-Tips_Balance.png";
import SP3Image from "../../assets/images/HIW-SP3-My_Withdrawal.png";
import TP1Image from "../../assets/images/HIW-TP1-Scan_QR.png";
import TP2Image from "../../assets/images/HIW-TP2-Payment.png";
import TP3Image from "../../assets/images/HIW-TP3-Review.png";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 h-full">
          ...
          <div className="space-y-8 h-full">
            <h3 className="text-3xl font-bold mb-12 text-center">
              <span className="bg-gradient-to-r from-white to-[#8B3DFF] bg-clip-text text-transparent">
                Service Provider
              </span>
            </h3>
            ...
            <div className="flex flex-col justify-between h-[calc(100%-80px)]">
              {serviceProviderSteps.map((step) => (
                <button
                  ...
                  onClick={() =>
                    setActiveStep((prev) =>
                      prev === step.number ? null : step.number
                    )
                  }
                ...
                >
                  ...
                  {/* Circle Button */}
                  <div
                    className={`flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center font-bold text-lg transition-all cursor-pointer ${
          ...
          <div className="space-y-8 h-full">
            <h3 className="text-3xl font-bold mb-12 text-center">
              <span className="bg-gradient-to-r from-[#3A7CFD] to-white bg-clip-text text-transparent">
                Tipper
              </span>
            </h3>
